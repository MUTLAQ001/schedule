...
<div class="gen-option gen-option-quick ${saved.mode === 'quick' ? 'selected' : ''}" data-mode="quick"><i class="ph ph-lightning"></i><div><div class="g-title">مثل طريقة الجامعة <span class="gen-quick-badge">ينصح به</span></div><div class="g-desc">ينزّل المقرر واللي يتبع له مثل طريقة الإضافة بموقع الجامعة</div></div></div>
