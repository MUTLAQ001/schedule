Object.assign(QU_ScheduleApp, {
        ...
        _showMobileSectionDetails(section, group, shouldUpdatePanel = true) {
          ...
          const editBtn = panel.querySelector('#sheet-edit-btn'); if (editBtn) { editBtn.onclick = () => { this._hideMobileSectionDetails(); this._showSectionEditor(section.uniqueId); }; }
